...
INSERT INTO `Books` (`id`, `title`, `author`, `average_rating`, `isbn`, `isbn13`) VALUES
(1, 'A Man Called Ove', 'Fredrik Backman', 4.5, '1476738017', '9781476738017');
...
-- (2, 'fsdA Man Called Ove', 'Fredrik Backman', 4.5, '1476738017', '9781476738017', 'ENG', 337, 600, 300, '2012-08-01', 'Atria Books', 20, 20, 1);
--

INSERT INTO `customer` (`id`, `name`, `email`, `registered_on`, `outstanding_debt`, `amount_spent`) VALUES
(1, 'Mitul David', 'mituldavid@gmail.com', '2021-06-14 11:23:01', 15, 50);
INSERT INTO `customer` (`id`, `name`, `email`, `registered_on`, `outstanding_debt`, `amount_spent`) VALUES
(2, 'dfsMitul David', 'mituldavid@gmail.com', '2021-06-14 11:23:01', 15, 50);


INSERT INTO `transactions` (`id`, `book_id`, `customer_id`, `per_day_fee`, `borrowed_on`, `returned_on`, `total_charge`, `amount_paid`) VALUES
